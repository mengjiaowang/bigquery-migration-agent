...
DELETE FROM `your-project-id.your_dataset.db_target`
WHERE dt = '2023-10-01';
-- Step 2: Insert new data (include partition column in SELECT)
INSERT INTO `your-project-id.your_dataset.db_target` (col1, col2, dt)
SELECT col1, col2, '2023-10-01'
FROM `your-project-id.your_dataset.db_source`;
COMMIT TRANSACTION;
```
...
Dynamic Tables (Read):** `FROM db.table_${{zdt...}}` ➡️ `FROM \`your-project-id.your_dataset.db_table_*` WHERE _TABLE_SUFFIX = ...`
